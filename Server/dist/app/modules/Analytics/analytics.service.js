 ...
 */
const crimesPerHour = () => __awaiter(void 0, void 0, void 0, function* () {
    const q = `
    WITH recent AS (
      SELECT "crimeDate"
      FROM posts
    ...
    ORDER BY hour;
  `;
    const r = yield database_1.default.query(q);
    return r.rows;
});
const crimeTrendWithMovingAvg = () => __awaiter(void 0, void 0, void 0, function* () {
    const q = `
    WITH daily AS (
...
const hotspotDistricts = () => __awaiter(void 0, void 0, void 0, function* () {
    const q = `
    SELECT 
      d.name as district, 
      COUNT(p.id) as cnt, 
...
const timePatternAnalysis = () => __awaiter(void 0, void 0, void 0, function* () {
    const q = `
...
const verificationAnalytics = () => __awaiter(void 0, void 0, void 0, function* () {
    const q = `
    WITH buckets AS (
      SELECT case
...
const responseEffectiveness = () => __awaiter(void 0, void 0, void 0, function* () {
...
const topContributors = () => __awaiter(void 0, void 0, void 0, function* () {
    const q = `
...
const crimeTypeDistribution = () => __awaiter(void 0, void 0, void 0, function* () {
...
const statusBreakdown = () => __awaiter(void 0, void 0, void 0, function* () {
    const q = `
    SELECT 
      status,
      COUNT(*) as cnt,
...
const divisionStats = () => __awaiter(void 0, void 0, void 0, function* () {
    const q = `
    SELECT 
      dv.name as division,
      COUNT(p.id) as cnt,
...
const crimesByDayOfWeek = () => __awaiter(void 0, void 0, void 0, function* () {
    const q = `
    SELECT 
...
const recentCrimeActivity = () => __awaiter(void 0, void 0, void 0, function* () {
    const q = `
    SELECT 
...
const polarHeatmapData = (latitude, longitude, radiusKm, startDate, endDate, category) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (startDate && endDate) {
        dateFilter = `AND p."crimeDate" >= $${paramIndex} AND p."crimeDate" <= $${paramIndex + 1}`;
  ...
  `;
    const r = yield database_1.default.query(q, params);
    return r.rows;
});
